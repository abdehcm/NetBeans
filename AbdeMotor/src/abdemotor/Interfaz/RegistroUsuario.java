...
public class RegistroUsuario extends javax.swing.JFrame {
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        ...
        String rol = jComboBoxRol.getSelectedItem().toString(); // Suponiendo que tienes un JComboBox para seleccionar el rol.

        String url = "jdbc:mysql://localhost:3306/abdemotor";
        String user = "root"; // Cambia esto si usas otro usuario en MySQL
